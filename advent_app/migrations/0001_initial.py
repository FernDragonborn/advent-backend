# Generated by Django 4.2 on 2024-11-25 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.CharField(choices=[('First group', 'First'), ('Second group', 'Second'), ('Third group', 'Third')], default='First group', max_length=255)),
                ('due_date', models.DateTimeField()),
                ('intro_text', models.TextField(null=True)),
                ('outro_text', models.TextField(null=True)),
                ('task_test', models.TextField(null=True)),
                ('task_image_1', models.ImageField(null=True, upload_to='')),
                ('task_image_2', models.ImageField(null=True, upload_to='')),
                ('task_image_3', models.ImageField(null=True, upload_to='')),
                ...
                ('points_award', models.SmallIntegerField(default=5)),
            ],
        ),
        migrations.CreateModel(
            name='TaskResponse',
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advent_app.task')),
